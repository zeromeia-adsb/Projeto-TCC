...
def orcamento_itens(id_cliente, id_veiculo):
    ...
    if request.method == 'POST':
        ...
        return render_template('orcamento.html', cliente=cliente, veiculo=veiculo, servico=servico, produto=produto, orcamento=orcamento, valor_total=valor_total)
...
def edita_orcamento(id):
    ...
    if request.method == 'POST':
        ...
        return render_template("consultar_orcamentos.html", mensagem_editar=mensagem, orcamento=orcamento, servico=servico, produto=produto)
    return render_template('editar_orcamento.html', orcamento=orcamento, servico=servico, produto=produto)
